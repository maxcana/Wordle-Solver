...

{
    ...
    List<Colour> colours = new List<Colour> { Colour.Gray, Colour.Green, Colour.Yellow, Colour.Yellow, Colour.Gray };
    ...
    public static List<string> dictionaryWithoutBadWords = dictionary;
